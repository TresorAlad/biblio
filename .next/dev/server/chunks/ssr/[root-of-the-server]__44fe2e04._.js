...
const api = {
    ...
    async register (nomComplet, email, password, role) {
    ...
    async listLivres (params) {
        const q = new URLSearchParams();
        if (params?.search) q.set('search', params.search);
        if (params?.categorieId) q.set('categorie_id', String(params.categorieId));
        const data = await apiFetch(`/livres${q.toString() ? `?${q.toString()}` : ''}`);
        return data.map(toLivre);
    },
    async createEmprunt (livreId, adherentId) {
        const body = {
            livre_id: Number(livreId),
            adherent_id: Number(adherentId || 0),
            duree_jours: 30
        };
        const e = await apiFetch('/emprunts', {
            method: 'POST',
            body: JSON.stringify(body)
        });
        return toEmprunt(e);
    },
    async listEmprunts (params) {
        const q = new URLSearchParams();
        if (params?.adherentId) q.set('adherent_id', params.adherentId);
        const data = await apiFetch(`/emprunts${q.toString() ? `?${q.toString()}` : ''}`);
        return data.map(toEmprunt);
    },
    async retourEmprunt (empruntId) {
        const e = await apiFetch(`/emprunts/${empruntId}/retour`, {
            method: 'POST'
        });
        return toEmprunt(e);
    },
    async createReservation (livreId) {
    ...
    async listReservations (params) {
        const q = new URLSearchParams();
        if (params?.adherentId) q.set('adherent_id', params.adherentId);
        const data = await apiFetch(`/reservations${q.toString() ? `?${q.toString()}` : ''}`);
        return data.map(toReservation);
    },
    async annulerReservation (reservationId) {
        const r = await apiFetch(`/reservations/${reservationId}/annuler`, {
            method: 'POST'
        });
        return toReservation(r);
    },
    async notifierReservation (reservationId) {
        const r = await apiFetch(`/reservations/${reservationId}/notifier`, {
            method: 'POST'
        });
        return toReservation(r);
    },
    async emprunterDepuisReservation (reservationId) {
        return await apiFetch(`/reservations/${reservationId}/emprunter`, {
            method: 'POST'
        });
    },
    async listAmendes (params) {
        const q = new URLSearchParams();
        if (params?.adherentId) q.set('adherent_id', params.adherentId);
        const data = await apiFetch(`/penalites${q.toString() ? `?${q.toString()}` : ''}`);
        return data.map(toAmende);
    },
    async payerAmende (amendeId) {
        const p = await apiFetch(`/penalites/${amendeId}/payer`, {
            method: 'POST'
        });
        return toAmende(p);
    },
    async listAdherents () {
        const data = await apiFetch('/adherents');
        return data.map((a)=>({
                id: String(a.id),
                nom: a.nom,
                prenom: a.prenom,
...
"[project]/app/auth-context.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStoredUser"])());
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStoredToken"])();
        if (!token) return;
        let cancelled = false;
        (async ()=>{
            setIsLoading(true);
            try {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearAuth"])();
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (email, password)=>{
        setIsLoading(true);
        try {
            const u = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].login(email, password);
            setUser(u);
            return u;
        } finally{
            setIsLoading(false);
    ...
    const register = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (name, email, password, role)=>{
        setIsLoading(true);
        try {
            const u = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].register(name, email, password, role);
            setUser(u);
            return u;
        } finally{
            setIsLoading(false);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        fileName: "[project]/app/auth-context.tsx",
        lineNumber: 70,
        columnNumber: 5
    }, this);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__44fe2e04._.js.map