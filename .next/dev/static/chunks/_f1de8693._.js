...
"[project]/app/auth-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[login]": async (email, password)=>{
            ...
            try {
                ...
                // Simple mock: determine role based on email patterns
                let role = 'ADHERENT';
                if (email.includes('biblio') || email.includes('librarian')) {
                    role = 'BIBLIOTHECAIRE';
                }
                const mockUser = {
    ...
    const register = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[register]": async (name, email, password, role)=>{
            setIsLoading(true);
            try {
                // Mock registration
                await new Promise({
...
_s(AuthProvider, "uqJdkAXqh9jhNmcWEDjVQw86X7M=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=_f1de8693._.js.map